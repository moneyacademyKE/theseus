...
> Transition note: `/design-engineering` is now the preferred umbrella skill for animation and motion review. Keep this skill for compatibility and use its content plus `STANDARDS.md` as the Motion Review mode inside `/design-engineering`.
