...
> Transition note: `/design-engineering` is now the preferred umbrella skill for naming/designing/reviewing motion. Keep this skill for compatibility and use its glossary as the Vocabulary Lookup mode inside `/design-engineering`.
