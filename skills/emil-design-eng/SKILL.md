...
> Transition note: `/design-engineering` is now the preferred umbrella skill for UI craft and polish. Keep this skill for compatibility and use its content as the Craft Polish mode inside `/design-engineering`.
