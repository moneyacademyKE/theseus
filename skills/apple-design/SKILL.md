...
> Transition note: `/design-engineering` is now the preferred umbrella skill for fluid interaction, gestures, springs, and material hierarchy. Keep this skill for compatibility and use its content as the Fluid Interaction mode inside `/design-engineering`.
