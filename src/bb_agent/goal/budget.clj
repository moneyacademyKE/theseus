(ns bb-agent.goal.budget
  ...
  The runner treats that as accounting metadata only. Truth still comes from
...
(defn usage
  ...
  Returns only counters the runner understands, with absent/non-numeric values as 0."
  [result]
